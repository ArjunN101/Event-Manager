...
<body>
    <div class="container">
        <div class="container-box">
            <div class="header">
                {{-- <img src="{{ $message->embed($pathToLogo) }}" style="height: 100px; padding-bottom: 10px;"> --}}
            ...
            <div style="padding: 30px;">
                <div class="ticket">
                    <table cellspacing="0" cellpadding="0" width="100%">
                        ...
                        <tr>
                            <td>
                                {{-- <img src="{{ $message->embed($eventBanner) }}" style="height: 70px; border-radius: 5px;"> --}}
                                <img src="{{ asset('storage/events/'.$booking->eventDetail->picture) }}" style="height: 70px; border-radius: 5px;">
                            </td>
