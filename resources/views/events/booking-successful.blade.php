...
<head>
    ...
    <title>getThrills.com | Booking Successful</title>
        ...
        <div class="message-box p-3">
           <div class="ticked text-center">
            ...
            <div class="booking text-center px-5 py-3">
                <p>Your Tickets has been successfully booked with Booking ID <span class="text-dark">{{ $booking_id }}</span>. An e-ticket has been sent to your email address and Mobile number. You can also download your e-ticket from My Ticket.</p>
            </div>
            <div class="d-flex justify-content-around pb-3">
                <a href="/"><button class="btn btn-primary text-uppercase px-4">Home</button></a>
                <a href="{{ route('myticket') }}"><button class="btn btn-danger text-uppercase">My Ticket</button></a>
            </div>
        </div>
    </section>
